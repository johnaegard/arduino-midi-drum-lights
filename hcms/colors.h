...
const RGBB BLUEWHITE = RGBB(216, 216, 255);
const RGBB DARKBLUEWHITE = RGBB(64, 64, 96);
const RGBB GREEN_HEAVY_TEAL = RGBB(0,255,160);
const RGBB GREEN_HEAVY_YELLOW = RGBB(120,255,0);


const RGBB COOLBLUE = RGBB( 96,116,255);
const RGBB COOLGREEN = RGBB( 115,235,74);
const RGBB COOLVIOLET = RGBB(140,101,211);
